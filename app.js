// app.js — Smart Scanner v4.3（完整功能）

// 1) Firebase 初始化（使用你提供的專案設定）
...
function log(msg){ const b=$("debug-log"); if(!b) return; const t=document.createElement("div"); t.textContent=msg; b.appendChild(t); }

// 3) Auth（按鈕永遠可點，寫入時才檢查登入）
